...
namespace CM
{
    static class ChartExtras
    {
        ...
        public static void addAreaGraph(this Chart _ch, string _name, Color _color, IEnumerable<double> _data)
        {
            ChartArea a = _ch.ChartAreas.FindByName(name);
            if (a == null) _ch.ChartAreas.Add(name);
            _ch.ChartAreas[name].AxisX.Minimum = 0;
        ...
        public static void setXInterval(this Chart _ch, double _interval)
        {
            ChartArea a = _ch.ChartAreas.FindByName(name);
            if (a == null) _ch.ChartAreas.Add(name);
            a.AxisX.Interval = _interval;
        }
        ...
        public static void addAreaGraph(this Chart _ch, string _name, Color _color, IEnumerable<double> _x, IEnumerable<double> _y)
        {
            ChartArea a = _ch.ChartAreas.FindByName(name);
            if (a == null) _ch.ChartAreas.Add(name);
            Series ser = _ch.Series.FindByName(_name);
